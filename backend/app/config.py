...
class Settings(BaseSettings):
    ...
    # Database - defaults to SQLite, override with DATABASE_URL for PostgreSQL
    DATABASE_URL: str = "sqlite:///./godeyes.db"
    ...
    CORS_ORIGINS: list[str] = [
        "http://localhost:3000",
        "http://localhost:5173",
        "https://god-eyes-gaga.vercel.app",
        "https://godeyes.vercel.app",
    ]
